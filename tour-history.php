...
foreach($results as $result)
{
	...
	$a=explode("/",$fdate); //strip
	$val=array_reverse($a); //reverse
	$mydate =implode("/",$val); //join
...
<html>
<head>
<title>TravelTrack | Travelling Management System</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TravelTrack -Travelling Management System</h1>
	</div>
</div>
...
<th>Serial No</th>
<th>Booking Id</th>
<th>Detailed Spot Description</th>	
<th>From</th>
<th>To</th>
...
<?php include('includes/signup.php');error_reporting(0);?>			
<?php include('includes/signin.php');error_reporting(0);?>			
</body>
</html>
<?php } ?>
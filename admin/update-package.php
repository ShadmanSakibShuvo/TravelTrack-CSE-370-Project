...
<html>
<head>
<title>TravelTrack | Admin Package Creation</title>
...
{	?>
							...
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagename" id="packagename" placeholder="Name" value="<?php echo htmlentities($result->PackageName);?>" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagetype" id="packagetype" placeholder=" Package Type" value="<?php echo htmlentities($result->PackageType);?>" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Price (in TK)</label>
									<div class="col-sm-8">

...
<html>
<head>
<title>TravelTrack | Travelling Route Management System</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">tzTRMS-Travelling Route Management System</h1>
	</div>
</div>
...
<?php }} ?>
			...
			<p style="width: 350px;">
<button type="submit" name="submit6" class="btn-primary btn">Update Profile</button>
			</p>
			</form>
	</div>
</div>
